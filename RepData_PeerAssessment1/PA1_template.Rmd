...
```
Thus, the mean and median steps taken per day were `r mean1` and `r median1` respectively.
...
```
The time at which the most steps were taken on average was at `r max_time`.
...
```
In this dataset, the mean and median steps taken per day were `r mean2` and `r median2` respectively.
